...
public class Balance {
    ...
    public Balance(Integer balanceId, Integer packageId, Integer customerId,
                   Integer partitionId, Integer balanceLevelMinutes, Integer balanceLevelSMS,
                   Integer balanceLevelData, Integer balanceLevelMoney, Date sDate, Date eDate, long price) {
    ...
    public Integer getBalanceLevelMinutes() { return balanceLevelMinutes; }
    public void setBalanceLevelMinutes(Integer balanceLevelMinutes) { this.balanceLevelMinutes = balanceLevelMinutes; }

    public Integer getBalanceLevelSMS() { return balanceLevelSMS; }
    public void setBalanceLevelSMS(Integer balanceLevelSMS) { this.balanceLevelSMS = balanceLevelSMS; }

    public Integer getBalanceLevelData() { return balanceLevelData; }
    public void setBalanceLevelData(Integer balanceLevelData) { this.balanceLevelData = balanceLevelData; }

    public Integer getBalanceLevelMoney() { return balanceLevelMoney; }
    public void setBalanceLevelMoney(Integer balanceLevelMoney) { this.balanceLevelMoney = balanceLevelMoney; }
