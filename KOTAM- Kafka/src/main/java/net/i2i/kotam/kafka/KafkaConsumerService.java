...
public class KafkaConsumerService implements Runnable {
    ...
    public KafkaConsumerService(String bootstrapServers, String groupId, String... topics) {
        if (bootstrapServers == null || bootstrapServers.trim().isEmpty()) {
            throw new IllegalArgumentException("bootstrapServers parametresi boş veya null olamaz.");
        }
        if (groupId == null || groupId.trim().isEmpty()) {
            throw new IllegalArgumentException("groupId parametresi boş veya null olamaz.");
        }
        if (topics == null || topics.length == 0) {
            throw new IllegalArgumentException("En az bir topic belirtilmelidir.");
        }
