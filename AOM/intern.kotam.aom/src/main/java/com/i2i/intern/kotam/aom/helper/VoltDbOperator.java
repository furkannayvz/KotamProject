...
public class VoltDbOperator {
    ...
    public void updateSmsBalance(String msisdn, int sms) throws IOException {
        String urlString = urlBase + "balances/sms?msisdn=" + msisdn + "&sms=" + sms;
        ...
        int responseCode = conn.getResponseCode();
        System.out.println(" SMS Güncelleme Yanıt Kodu: " + responseCode);

        conn.getInputStream().close();
    }

    public void updateMinutesBalance(String msisdn, int minutes) throws IOException {
        String urlString = urlBase + "balances/minutes?msisdn=" + msisdn + "&minutes=" + minutes;
        URL url = new URL(urlString);
        ...
        int responseCode = conn.getResponseCode();
        System.out.println(" Dakika Güncelleme Yanıt Kodu: " + responseCode);

        conn.getInputStream().close();
    }

    public void updateDataBalance(String msisdn, int data) throws IOException {
        String urlString = urlBase + "balances/data?msisdn=" + msisdn + "&data=" + data;
        URL url = new URL(urlString);
        ...
        int responseCode = conn.getResponseCode();
        System.out.println(" Data Güncelleme Yanıt Kodu: " + responseCode);
