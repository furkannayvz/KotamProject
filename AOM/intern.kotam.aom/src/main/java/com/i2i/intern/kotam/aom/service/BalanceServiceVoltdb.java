...
public class BalanceServiceVoltdb  {
    ...
    public boolean updateMinutesBalance(String msisdn, Long minutes) {
        try {
            voltDbOperator.updateMinutesBalance(msisdn, minutes.intValue());
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public boolean updateSmsBalance(String msisdn, Long sms) {
        try {
            voltDbOperator.updateSmsBalance(msisdn, sms.intValue());
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public boolean updateDataBalance(String msisdn, Long data) {
        try {
            voltDbOperator.updateDataBalance(msisdn, data.intValue());
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
