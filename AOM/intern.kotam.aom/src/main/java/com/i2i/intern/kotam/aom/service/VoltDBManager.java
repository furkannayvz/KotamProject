...
public class VoltDBManager {
    ...
    public JSONObject insertNotification(String msisdn, String message, String notificationType, boolean isRead) throws Exception {
        return executeProcedure("INSERT_NOTIFICATION", msisdn, message, notificationType, isRead);
    }

    public JSONObject getNotificationById(Long notificationId) throws Exception {
        return executeProcedure("GET_NOTIFICATION_BY_ID", notificationId);
    }

    public JSONObject getNotificationsByMsisdn(String msisdn) throws Exception {
        return executeProcedure("GET_NOTIFICATIONS_BY_MSISDN", msisdn);
    }

    public JSONObject getUnreadNotificationsByMsisdn(String msisdn) throws Exception {
        return executeProcedure("GET_UNREAD_NOTIFICATIONS_BY_MSISDN", msisdn);
    }

    public JSONObject updateNotification(Long notificationId, String message, String notificationType, boolean isRead) throws Exception {
        return executeProcedure("UPDATE_NOTIFICATION", notificationId, message, notificationType, isRead);
    }

    public JSONObject markNotificationAsRead(Long notificationId) throws Exception {
        return executeProcedure("MARK_NOTIFICATION_AS_READ", notificationId);
    }

    public JSONObject markAllNotificationsAsRead(String msisdn) throws Exception {
        return executeProcedure("MARK_ALL_NOTIFICATIONS_AS_READ", msisdn);
    }

    public JSONObject deleteNotification(Long notificationId) throws Exception {
        return executeProcedure("DELETE_NOTIFICATION", notificationId);
    }

    public JSONObject deleteAllNotificationsByMsisdn(String msisdn) throws Exception {
        return executeProcedure("DELETE_ALL_NOTIFICATIONS_BY_MSISDN", msisdn);
    }

    public JSONObject getUnreadNotificationCount(String msisdn) throws Exception {
        return executeProcedure("GET_UNREAD_NOTIFICATION_COUNT", msisdn);
    }

    public JSONObject getAllNotifications() throws Exception {
        return executeProcedure("GET_ALL_NOTIFICATIONS");
    }

    // PersonalUsage-specific methods (if needed)
    public JSONObject getPersonalUsageByMsisdn(String msisdn) throws Exception {
        return executeProcedure("GET_PERSONAL_USAGE_BY_MSISDN", msisdn);
    }

    public JSONObject insertPersonalUsage(String msisdn, Long dataUsed, Long smsUsed, Long minutesUsed) throws Exception {
        return executeProcedure("INSERT_PERSONAL_USAGE", msisdn, dataUsed, smsUsed, minutesUsed);
    }

    public JSONObject updatePersonalUsage(String msisdn, Long dataUsed, Long smsUsed, Long minutesUsed) throws Exception {
        return executeProcedure("UPDATE_PERSONAL_USAGE", msisdn, dataUsed, smsUsed, minutesUsed);
    }
