...
import com.i2i.intern.kotam.aom.filter.JwtAuthenticationFilter;
...
import static com.i2i.intern.kotam.aom.enums.Role.ADMIN;
import static com.i2i.intern.kotam.aom.enums.Role.USER;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        // Giriş, kayıt gibi public endpoint'ler
                        .requestMatchers(AUTH_WHITELIST).permitAll()

                        // Yetki gerektiren endpoint'ler
                        ...
                        // Diğer tüm endpoint'ler için kimlik doğrulama
                        .anyRequest()
                        .authenticated()
                )
